...
const Home = () => {
  return (
    <div className="rounded-lg ">
      <div className="relative w-full flex flex-col items-center justify-center mb-4 rounded-sm p-3 md:p-8 pt-[20%] md:pt-[10%] bg-radial-[at_75%_25%] from-[#7212c7] to-[#000000] to-50%">
