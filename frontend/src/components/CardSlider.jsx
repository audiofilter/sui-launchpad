        ...
        >
          ...
          >
            {cards.map((item, index) => (
              <motion.div
                key={item.id}
                className="flex-shrink-0 cursor-pointer p-4 bg-white shadow-md flex items-center justify-left rounded-3xl scroll-snap-align-start bg-radial-[at_-300%_70%] from-[#FF860A] to-[#161616] to-65%"
              >
                {/* Image */}
                <div class="w-50 h-50 flex items-center justify-center overflow-hidden rounded-xl bg-gray-200">
                  <img
                    src={item.image}
                    alt="Your Image"
